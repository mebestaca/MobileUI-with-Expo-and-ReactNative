...
import coinIcon from "../../images/coin_image.png";
import diamondIcon from "../../images/gem_image.png";
import triangleIcon from "../../images/stone_image.png";
import dropdownIcon from "../..//images/currencies_image.png";
import yellowTriangleIcon from "../..//images/yellowtriangle_image.png";
  ...
  return (
    ...
    >
        ...
        <View style={styles.topRow}>
            ...
            <View style={styles.statRow}>
                <Image source={diamondIcon} style={styles.icon} />
                <Text style={styles.stat}>1061</Text>
            </View>

            <View style={styles.statRow}>
                <Image source={triangleIcon} style={styles.icon} />
        ...
        <View style={styles.statRow}>
            <Image source={yellowTriangleIcon} style={styles.icon} />
